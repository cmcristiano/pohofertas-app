      ...
      <div className="mb-10 animate-bounce">
         <svg viewBox="0 0 260 50" className="w-[200px] md:w-[280px]" fill="none">
             <g transform="translate(0, 5)">
                < d="M5 20C5 14.4772 9.47715 10 15 10H30L50 30L30 50H15C9.47715 50 5 45.5228 5 40V20Z" fill="#FF6600" transform="rotate(-15 25 30)"/>
...
// --- CONFIGURAÇÃO: SEU WHATSAPP JÁ CONFIGURADO ---
...
const App = () => {
  ...
  const heroSlides = useMemo(() => {
    ...
    const valid = products.filter(p => new Date(p.validity).getTime() >= today.getTime()); 
...
export default App;
>>>>>>> 919326c74f7e678def3aedf8d64087c715ae3368
